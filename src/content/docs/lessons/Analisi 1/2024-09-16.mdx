...
- funzione limitata superiormente:
  $$\exists\ M\in{R}\ \vert\ \forall x\in{R}, f(x)\leq M$$;
- funzione limitata inferiormente:
  $$\exists\ m\in{R}\ \vert\ \forall x\in{R}, f(x)\geq m$$;
...
- funzione periodica: $$\exists\ T\in{R}, k\in{Z}\ \vert\ f(x+KT)=f(x)$$;

## Funzioni monotone

- crescente: $$x_1,x_2\in{R}, x_1<x_2 \rightarrow f(x_1)\leq f(x_2)$$;
- strettamente crescente: $$x_1,x_2\in{R}, x_1<x_2 \rightarrow f(x_1)<f(x_2)$$;
