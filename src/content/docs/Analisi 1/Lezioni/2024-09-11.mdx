...
- $$\mathbb{Q}=\left\{\frac{p}{q}\ \vert\ p,q\in{Z}, q\neq 0 \right\}$$
...
- $$[a,b]=\{x\in\mathbb{R}\ \vert\ a\leq x\leq b\}$$: intervallo chiuso.
...
$$\llcorner x\lrcorner=\sup{y \in\mathbb{Z}\ \vert\ y < x}$$
...
$$\exists x\in\mathbb{Q}\ \vert\ a<q<b$$
...
- $$(a<b)\equiv(b-a>0)$$
- $$\exists n\in\mathbb{N}\ \vert\ (n>\frac{1}{b-a})\equiv(b-a=\frac{1}{n}), n>0$$
