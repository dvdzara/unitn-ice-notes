...
- **Prodotto cartesiano**:
  $$A \times B = \PC{ \PR{a, b} \st a \in A \land b \in B }$$
...
- $$\lnot \PR{A \land B} = \PR{lnot A} \lor \PR{\lnot B}$$
- $$\lnot \PR{A \lor B} = \PR{\lnot A} \land \PR{\lnot B}$$
...
$$P \Leftrightarrow Q = \PR{P \Rightarrow Q} \land \PR{Q \Rightarrow P}$$

**Negazione di una proposizione con implicazioni**:

$$P \Rightarrow Q \equiv \PR{\lnot Q} \Rightarrow \PR{\lnot P}$$
