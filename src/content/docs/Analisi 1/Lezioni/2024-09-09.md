...
- $$A = \lb a, b, c, d, e \rb$$
- $$B = \lb \text{proprietà che accomuna gli elementi} \rb$$
- $$C = \lb 2k + 1 \st k = 0, 1, 2, \ldots \rb$$
...
- **Unione**: $$A \cup B = \lb x \st x \in A \lor x \in B \rb$$
- **Intersezione**: $$A \cap B = \lb x \st x \in A \land x \in B \rb$$
- **Differenza**: $$A \setminus B = \lb x \st x \in A \land x \notin B \rb$$
- **Prodotto cartesiano**:
  $$A \times B = \lb (a, b) \st a \in A \land b \in B \rb$$
