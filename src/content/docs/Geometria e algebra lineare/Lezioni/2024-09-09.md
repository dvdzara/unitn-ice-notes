...
- $$\lambda \PR{\mu \v{v}} = \PR{\lambda \mu} \v{v}$$
- $$1 \v{v} = \v{v}$$
- $$\PR{\lambda + \mu} \v{v} = \lambda \v{v} + \mu \v{v}$$
...
- $$\lambda \PR{\v{v}} \cdot \v{w} = \lambda \PR{\v{v} \cdot \v{w}}$$
- $$\v{v} \cdot \PR{\v{w} + \v{u}} = \v{v} \cdot \v{w} + \v{v} \cdot \v{u}$$
- $$\v{v} \cdot \v{v} = |\v{v}|^{2}$$
...
- con $$\v{w} \neq \v{0}$$, allora la proiezione di $$\v{v}$$ su $$\v{w}$$ è la
  ...
  $$\PR{\v{v} \cdot \frac{\v{w}}{|\v{w}|}} \frac{\v{w}}{|\v{w}|} = \PR{\frac{\v{v} \cdot \v{w}}{|\v{w}|^{2}}} \v{w}$$
