...
Un segmento orientato $$ \overrightarrow{AB}$$ è un segmento che ha come estremo
iniziale il punto $$A$$ e come estremo finale il punto $$B$$.

$$ \overrightarrow{AB}$$ e $$ \overrightarrow{CD}$$ sono equivalenti se hanno
uguali direzione, modulo e verso.
...
$$\underline{v} = \overrightarrow{AB} = \overrightarrow{CD}$$, con
$$\overrightarrow{AB} \equiv \overrightarrow{CD}$$ (v è il nome del vettore).

$$|\underline{v}|$$: modulo di $$\underline{v}$$, sempre $$\ge{0}$$, se
$$|\underline{v}| = 0$$ allora il vettore è nullo.

Vettore nullo: classe di equivalenza del segmento orientato
$$\overrightarrow{AA}$$ (estremo iniziale coincide con l'estremo finale),
direzione e verso sono indeterminati.

$$\underline{0} = \overrightarrow{AA}$$
...
- $$\underline{v}$$ e $$\underline{w}$$, con rappresentanti
  $$\underline{v} = \overrightarrow{AB}$$,
  $$\underline{w} = \overrightarrow{BC}$$;
- $$\underline{v}+\underline{w}$$ come la classe di equivalenza
  $$\overrightarrow{AC}$$;
